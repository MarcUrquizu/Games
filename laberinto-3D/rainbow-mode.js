  ...
  style.textContent = `
    ...
    .olap-rainbow-flag {
      ...
      background: repeating-linear-gradient(
        to bottom,
        #e40303 0px, #e40303 6px,
        #ff8c00 6px, #ff8c00 12px,
        #ffed00 12px, #ffed00 18px,
        #008026 18px, #008026 24px,
        #004dff 24px, #004dff 30px,
        #750787 30px, #750787 36px
      );
      border-radius: 3px;
